    ...
    <div className="flex flex-wrap -m-4">
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          ...
          <h2 className=" title-font text-lg font-medium text-TextColor">The Catalyzer</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          <h3 className=" text-xs tracking-widest title-font mb-1 text-TextColor">CATEGORY</h3>
          <h2 className=" title-font text-lg font-medium text-TextColor">Shooting Stars</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          <h3 className=" text-xs tracking-widest title-font mb-1 text-TextColor">CATEGORY</h3>
          <h2 className=" title-font text-lg font-medium text-TextColor">Neptune</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          <h3 className=" text-xs tracking-widest title-font mb-1 text-TextColor">CATEGORY</h3>
          <h2 className=" title-font text-lg font-medium text-TextColor">The 400 Blows</h2>
